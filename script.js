 ...
 *
 */
function updateDropdownLabel(newSemester) {
	if(dropdownText.textContent !== newSemester){
		dropdownText.textContent = newSemester;
...
// listeners are being added twice inside window.onload
